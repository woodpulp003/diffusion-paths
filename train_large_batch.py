...
def train_loop(
    ...
    for batch_idx, x_0 in enumerate(dataloader):
        ...
        if batch_idx % 10 == 0:  # Print more frequently for large batch training
...
def main():
    parser = argparse.ArgumentParser(description='Train diffusion model on 2D GMM data with large batch size')
    parser.add_argument('--seed', type=int, default=42, help='Random seed')
    parser.add_argument('--batch_size', type=int, default=1280, help='Batch size (10x original)')
    parser.add_argument('--epochs', type=int, default=100, help='Number of epochs')
    parser.add_argument('--lr', type=float, default=3.16e-5, help='Learning rate (scaled down by sqrt(10))')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints_large_batch', help='Checkpoint directory')
    parser.add_argument('--losses_file', type=str, default='losses_large_batch.csv', help='Losses CSV file')
    ...
    print(f"Batch size: {args.batch_size} (10x original)")
    print(f"Learning rate: {args.lr} (scaled down by sqrt(10))")
